          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1 dark:text-white">Welcome. We exist to make path of exile easier.</h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-3">
                    <div className="w-full px-3">
                      <button className="btn px-0 text-white bg-gray-900 dark:border-1 dark:border-white hover:bg-gray-800 w-full relative flex items-center">
                ...
                <div className="text-gray-600 dark:text-gray-400 text-center mt-6">
                  Already using Exilum? <Link to="/signin" className="text-blue-600 hover:underline transition duration-150 ease-in-out">Sign in</Link>
                </div>
              </div>
